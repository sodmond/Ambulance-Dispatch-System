...
<title>::.. Ambulance Profile Management</title>
<link rel="stylesheet" href="css/main.css" />
<script src="js/script.js"></script>
<script src="js/cookie.js"></script>
<style type="text/css">
.tabs{width:500px; height:25px; background:#903; margin-left:100px; padding:2px; font:0.9em Arial; border-radius:5px;}
.tabs a{color:#CCC; text-decoration:none;}
.tabs a:hover{color:#FFF;}
#tbl{width:100%; height:500px; overflow:scroll; background:#FFF;}
...
<div class="content">
<p>&nbsp;</p>
<?php if(isset($_COOKIE['del_ID'])){ unset($_COOKIE['del_ID']); } ?>
<div align="center" class="tabs">
<a href="profile_mgt.php">&crarr; back</a>&nbsp;&nbsp; | &nbsp;&nbsp;
<a href="amb_reg.php">Register an Ambulance</a>&nbsp;&nbsp; | &nbsp;&nbsp;
<a href="javascript:ambModProf();">Modify a Profile</a>&nbsp;&nbsp; | &nbsp;&nbsp;
<a href="javascript:ambDelProf();">Delete a Profile</a>
</div>
<hr />
<div id="tbl"><table width="700" border="1" bordercolor="#CCC" bgcolor="#FFF" cellpadding="0" cellspacing="0">
...
<?php
$sql = mysqli_query($conn, 'SELECT * FROM ambulance_info ORDER BY Amb_model');
while($row = mysqli_fetch_array($sql)){
	echo '<tr style="color:#000; font:1.0em Calibri; text-align:center;">';
	echo '<td>'.$row['Amb_id'].'</td>';
	echo '<td>'.$row['Amb_model'].'</td>';
