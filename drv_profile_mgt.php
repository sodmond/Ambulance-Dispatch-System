...
#tbl table{border:1px #CCC ridge;}
</style>
</head>
...
<div class="content">
<p>&nbsp;</p>
<?php if(isset($_COOKIE['del_ID'], $_COOKIE['mod_ID'])){ unset($_COOKIE['del_ID']); unset($_COOKIE['mod_ID']); } ?>
<div align="center" class="tabs">
<a href="profile_mgt.php">&crarr; back</a>&nbsp;&nbsp; | &nbsp;&nbsp;
<a href="drv_reg.php">Register a Driver</a>&nbsp;&nbsp; | &nbsp;&nbsp;
<a href="javascript:drvModProf();">Modify a Profile</a>&nbsp;&nbsp; | &nbsp;&nbsp;
<a href="javascript:drvDelProf();">Delete a Profile</a>&nbsp;&nbsp; | &nbsp;&nbsp;
<a href="drv_more.php">More</a>
</div>
<hr />
...
<?php
$sql = mysqli_query($conn, 'SELECT * FROM drivers_info ORDER BY Lastname');
